...
const NavBar = () => {
  ...
  <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
      ...
      <div>
        <Link to="/carrito" className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-mantis hover:bg-white mt-4 lg:mt-0">{<CartWidget/>}</Link>
      </div>
  </div>
</nav>
